...
[github repository settings]: https://github.com/SEEK-Jobs/raph-monkey/settings

## Design

raph-monkey is a Node.js [Lambda] application built in line with our [technology strategy].
...
```shell
curl --data '[{}, {"awsRequestId": "local"}]' --include localhost:27505
```
